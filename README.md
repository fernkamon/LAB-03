...
1.	นักศึกษาพบปัญหาในกานคอมไพล์โปรแกรมหรือไม่ ถ้าเจอให้บอกที่ผิดและแนวทางการแก้ไข
  ...
  * เมื่อทำการคอมไพล์แล้ว พบว่า ส่วนใหญ่จะ Error ตรงชนิดของ LPCWSTR ที่เป็นชนิด Char ดังรูปต่อไปนี้
  
 ![](https://github.com/fernkamon/LAB-03/blob/master/Error.PNG)
